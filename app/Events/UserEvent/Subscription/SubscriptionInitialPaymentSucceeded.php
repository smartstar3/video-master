...
class SubscriptionInitialPaymentSucceeded extends UserEvent
{
    use HandlesUserEventActions;

    protected static $action = 'subscription initial payment succeeded';
    ...
    public function dataPayload(): array
    {
        return [
            ...
            'payment_gateway_payment_id' => $this->paymentGatewayPaymentId,
        ];
    }
}
