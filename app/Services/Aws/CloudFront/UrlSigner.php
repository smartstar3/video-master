...
namespace MotionArray\Services\Aws\CloudFront;
 ...
 *
 * This class has been copied from `aws-php-sdk` 3.x version: https://github.com/aws/aws-sdk-php/blob/master/src/CloudFront/UrlSigner.php
 * Copied because we're not able to update it yet, because of other dependencies require 2.8.x.
 * We can remove this class after we update aws-php-sdk.
 */
class UrlSigner
{
    private $signer;
